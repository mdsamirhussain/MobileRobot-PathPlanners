...
**The following are the description of the algorithms included (red lines represent shortest path, hollow circles are obstacles and start and goal nodes are filled circles:**
